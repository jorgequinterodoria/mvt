...
class AccountController extends Controller{
	...
	function index(){
		...
		$record = $query->find($rec_id, Usuarios::accountviewFields());
		if(!$record){
     ...
     * @return \Illuminate\View\View;
     */
	function edit(UsuariosAccountEditRequest $request){
		$rec_id = Auth::id();
		$query = Usuarios::query();
		$user = $query->findOrFail($rec_id, Usuarios::accounteditFields());
