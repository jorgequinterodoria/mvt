            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("ejerciciosrutinas/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-id_ejercicio-holder" class=" ">
                                            <input id="ctrl-id_ejercicio" data-field="id_ejercicio"  value="<?php  echo $data['id_ejercicio']; ?>" type="number" placeholder="Escribir Ejercicio" step="any"  required="" name="id_ejercicio"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-id_rutina-holder" class=" ">
                                            ...
                                            <?php
                                                ...
                                                $selected = ( $value == $data['id_rutina'] ? 'selected' : null );
                                            ?>
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-repeticiones-holder" class=" ">
                                            ...
                                            <?php
                                                ...
                                                $value = $option->value;
                                                $label = $option->label ?? $value;
                                                $selected = ( $value == $data['repeticiones'] ? 'selected' : null );
                                            ?>
                                            <option <?php echo $selected; ?> value="<?php echo $value; ?>">
                                            <?php echo $label; ?>
                                            </option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-series-holder" class=" ">
                                            <input id="ctrl-series" data-field="series"  value="<?php  echo $data['series']; ?>" type="number" placeholder="Escribir Series" step="any"  required="" name="series"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
