            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("cambiofechas/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-id_suscripcion-holder" class=" ">
                                            ...
                                            <?php
                                                ...
                                                $selected = ( $value == $data['id_suscripcion'] ? 'selected' : null );
                                            ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-motivo-holder" class=" ">
                                            <textarea placeholder="Escribir Motivo" id="ctrl-motivo" data-field="motivo"  required="" rows="5" name="motivo" class=" form-control"><?php  echo $data['motivo']; ?></textarea>
